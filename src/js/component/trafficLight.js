...
export class TrafficLight extends React.Component {
	constructor() {
		super(); //hereda todo
		this.state = {
			//aqui van las propiedades del estado(state)
			//Este sera el estado inicial sera "red"
			clicked: "red"
		};
	}
	render() {
		let newRedLightClass = ""; //va declarada vacia
		let newYellowLightClass = "";
		let newGreenLightClass = "";

		if (this.state.clicked === "red") {
			newRedLightClass = "light-glow"; //para que se alumbre
